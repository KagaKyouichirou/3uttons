...
const colour fbd[35] = {N, R, R, G, N, G, Y, N, Y, Y, N, G, G, Y, N, N, R, R, N, G, Y, N, Y, Y, N, N, Y, R, Y, Y, Y, Y, G, R, N};
...
State YY(State s)
{
	if (s.p + 1 < 35 and Y != fbd[s.p] and Y != fbd[s.p + 1])
	{
		s.a[s.p] = Y;
		s.a[s.p + 1] = Y;
		s.p += 2;
...
State RR(State s)
{
	if (s.p + 2 < 35 and R != fbd[s.p] and R != fbd[s.p + 1] and R != fbd[s.p + 2])
	{
		s.a[s.p] = R;
		s.a[s.p + 1] = R;
		s.a[s.p + 2] = R;
...
State GG(State s)
{
	if (s.p + 3 < 35 and G != fbd[s.p] and G != fbd[s.p + 1] and G != fbd[s.p + 2] and G != fbd[s.p + 3])
	{
		s.a[s.p] = G;
		s.a[s.p + 1] = G;
		s.a[s.p + 2] = G;
